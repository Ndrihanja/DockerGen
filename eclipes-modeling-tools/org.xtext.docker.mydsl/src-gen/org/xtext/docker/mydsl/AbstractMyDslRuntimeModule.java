...
import org.xtext.docker.mydsl.formatting2.MyDslFormatter;
import org.xtext.docker.mydsl.generator.MyDslGenerator;
import org.xtext.docker.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import org.xtext.docker.mydsl.parser.antlr.MyDslParser;
import org.xtext.docker.mydsl.parser.antlr.internal.InternalMyDslLexer;
import org.xtext.docker.mydsl.scoping.MyDslScopeProvider;
import org.xtext.docker.mydsl.serializer.MyDslSemanticSequencer;
import org.xtext.docker.mydsl.serializer.MyDslSyntacticSequencer;
import org.xtext.docker.mydsl.services.MyDslGrammarAccess;
import org.xtext.docker.mydsl.validation.MyDslConfigurableIssueCodesProvider;
import org.xtext.docker.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/docker/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.docker.mydsl.MyDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("ditra");
	}
